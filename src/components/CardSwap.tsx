...
const CardSwap: React.FC<CardSwapProps> = ({
  ...
  }, [cardDistance, verticalDistance, delay, pauseOnHover, skewAmount, easing, refs, childArr.length]);

  // FIXED: TypeScript-safe rendered mapping
 const rendered = childArr.map((child, i) => {
  if (!isValidElement(child)) return child;
  
  // Type the child as a valid React element that accepts ref
